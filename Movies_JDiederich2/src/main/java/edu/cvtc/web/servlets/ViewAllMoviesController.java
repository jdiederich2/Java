...
/**
 * Servlet implementation class ViewAllMoviesController
 */
@WebServlet({ "/ViewAllMovies", "/ViewMovies" })
public class ViewAllMoviesController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			e.printStackTrace();
			request.setAttribute("message", "Unable to retrieve movie list.");
			target = "error.jsp";
		}
